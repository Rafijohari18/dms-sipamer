    ...
    <md-app-toolbar class="md-primary md-large align-items-start">
      ...
      <md-app-content >
        <div class="container" >
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="ml-0">
                                    ...
                                    <h3 class="mount-card-persen" v-if="jumlahPesk.length > 0">{{ sumpesk(jumlahPesk) }} / {{ wadahPesk }} KG</h3>   
                            ...
                            <md-progress-bar md-mode="determinate" v-if="jumlahPesk.length > 0" :md-value="Number(( sumpesk(jumlahPesk) / wadahPesk ) * 100).toFixed(2)"></md-progress-bar>
                            ...
                            <div class="row align-items-center mt-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <h4 class="text-right mt-3" v-else>
                                        0 %
                                    </h4>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="ml-0">
                                    ...
                                    <h3 class="mount-card-persen" v-if="jumlahThermometer.length > 0">{{ sumalkes(jumlahThermometer) }} / {{ wadahThermometer }} PCS</h3>   
                                    <h3 class="mount-card-persen" v-else>0 / {{ wadahThermometer }} PCS</h3>   
                            ...
                            <div class="row align-items-center mt-2">
                                ...
                                <div class="col-md-6">
                                     <h4 class="text-right mt-3" v-if="jumlahThermometer.length > 0">
                                        {{ Number(( sumalkes(jumlahThermometer) / wadahThermometer ) * 100).toFixed(2) }} %
                                    </h4>
                                    <h4 class="text-right mt-3" v-else>
                                        0 %
                                    </h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="ml-0">
                                    ...
                                    <h3 class="mount-card-persen" v-if="jumlahTensimeter.length > 0">{{ sumalkes(jumlahTensimeter) }} / {{ wadahTensimeter }} PCS</h3>   
                                    <h3 class="mount-card-persen" v-else> 0 / {{ wadahTensimeter }} PCS</h3>   
                            ...
                            <md-progress-bar v-if="jumlahTensimeter.length > 0" md-mode="determinate" :md-value="Number(( sumalkes(jumlahTensimeter) / wadahTensimeter ) * 100).toFixed(2)"></md-progress-bar>
                            ...
                            <div class="row align-items-center mt-2">
                                ...
                                <div class="col-md-6">
                                    <h4 class="text-right mt-3" v-if="jumlahTensimeter.length > 0">
                                        {{ Number(( sumalkes(jumlahTensimeter) / wadahTensimeter ) * 100).toFixed(2) }} %
                                    </h4>
                                    <h4 class="text-right mt-3" v-else>
                                    0 %
                                    </h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="ml-0">
                                    ...
                                    <h3 class="mount-card-persen" v-if="jumlahAmalgam.length > 0">{{ sumalkes(jumlahAmalgam) }} / {{ wadahAmalgam }} PCS</h3>   
                                    <h3 class="mount-card-persen" v-else> 0 / {{ wadahAmalgam }} PCS</h3>   
                            ...
                            <md-progress-bar v-if="jumlahAmalgam.length > 0" md-mode="determinate" :md-value="Number(( sumalkes(jumlahAmalgam) / wadahAmalgam ) * 100).toFixed(2)"></md-progress-bar>
                            <md-progress-bar v-else md-mode="determinate" :md-value="0"></md-progress-bar>
                            ...
                            <div class="row align-items-center mt-2">
                                ...
                                <div class="col-md-6">
                                    <h4 class="text-right mt-3" v-if="jumlahAmalgam.length > 0">
                                        {{ Number(( sumalkes(jumlahAmalgam) / wadahAmalgam ) * 100).toFixed(2) }} %
                                    </h4>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="item-filter">
                                ...
                                <b-check v-model="sortir_merkuri" value="0" >Pesk</b-check>
                                <b-check v-model="sortir_merkuri" value="1" >Thermometer</b-check>
                                <b-check v-model="sortir_merkuri" value="2" >Tensimeter Meja</b-check>
                                <b-check v-model="sortir_merkuri" value="3" >Tensimeter Berdiri</b-check>
                                <b-check v-model="sortir_merkuri" value="4" >Dental Amalgam </b-check>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="item-filter">
                                <h6>Sortir Gudang</h6>
                                <b-check v-model="sortir_gudang" value="0">Interim Kab / Kota</b-check>
                                <b-check v-model="sortir_gudang" value="1">Interim Provinsi</b-check>
                                <b-check v-model="sortir_gudang" value="2">Final</b-check>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="item-filter">
                                <h6>Sortir Status Shipping</h6>
                                    ...
                                    <b-check v-model="status_shipping" value="2">Pending </b-check>
                                    <!-- status 2 -->

                                    <b-check v-model="status_shipping" value="0">On Going </b-check>
                                    <!-- status 0 -->

                                    <b-check v-model="status_shipping" value="1">Sukses </b-check>
                                    <!-- status 1 -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <gmap-map :center="center" :zoom="5" ref="mmm" style="width: 100%; height:600px">
                         <gmap-info-window :options="option" :position="infoWindowPos" :opened="infoWinOpen" @closeclick="close">
                        </gmap-info-window>
                        ...
                        >
                            ...
                            :icon="value.jenis == 0 && value.status_shipping == 0   ? peskbelum : 
                            value.jenis == 0 && value.status_shipping == 1 ? pesksudah : 
                            value.laporan == 'pesk' ? peskpending : 
                            value.jenis == 1 && value.status_shipping == 0 ? termometerbelum : 
                            value.jenis == 1 && value.status_shipping == 1 ? termometersudah : 
                            value.laporan == 'alkes' && value.akumulasi_termometer != '0' ? termometerpending : 
                            value.jenis == 2 && value.status_shipping == 0 ? tensimejabelum : 
                            value.jenis == 2 && value.status_shipping == 1 ? tensimejasudah : 
                            value.laporan == 'alkes' && value.akumulasi_tensimeter_meja != '0' ? tensimejapending : 
                            value.jenis == 3 && value.status_shipping == 0 ? tensidiribelum : 
                            value.jenis == 3 && value.status_shipping == 1 ? tensidirisudah : 
                            value.laporan == 'alkes' && value.akumulasi_tensimeter_berdiri != '0' ? tensidiripending :
                            value.jenis == 4 && value.status_shipping == 0 ? amalgambelum : 
                            value.jenis == 4 && value.status_shipping == 1 ? amalgamsudah : 
                            value.laporan == 'alkes' && value.jml_merkuri_sisa_amalgam != '0' ? amalgampending :
                            value.sifat == 0 ? storagekab : 
                            value.sifat == 1 ? storageprov : 
                            value.sifat == 2 ? storagefin : 
                            transparent
                            " >
                            </gmap-marker>
                        </div>
                ...
                <div class="col-md-6">
                    <b-card class="mb-4  text-center">
                        ...
                        <h2 class="text-data purple">
                            {{ 
                                Number((jumlahPesk.length > 0 ? sumpesk(jumlahPesk) / wadahPesk * 100 : 0 + 
                                jumlahThermometer.length > 0 ? sumalkes(jumlahThermometer) / wadahThermometer * 100 : 0 + 
                                jumlahTensimeter.length > 0 ? sumalkes(jumlahTensimeter) / wadahTensimeter * 100 : 0 + 
                                jumlahAmalgam.length > 0 ? sumalkes(jumlahAmalgam) / wadahAmalgam * 100 : 0 ) / 4).toFixed(2) 
                            }} %
                            ...
                            <table class="table table-hover ">
                                ...
                                <tbody>
                                    <tr v-for="(item,key) in storage" :key="key">
                                        ...
                                        <td>
                                        {{ Number(item.persentaseall.toFixed(2)) }}%
